 ...
 */
#ifndef SATELLITE_GLOBAL_ROUTING_HELPER_H
#define SATELLITE_GLOBAL_ROUTING_HELPER_H
 ...
 */
class SatelliteGlobalRoutingHelper  : public Ipv4RoutingHelper
{
public:
  /**
   ...
   */
  SatelliteGlobalRoutingHelper (const SatelliteGlobalRoutingHelper &);
...
private:
   ...
   * \return
   */
  SatelliteGlobalRoutingHelper &operator = (const SatelliteGlobalRoutingHelper &);
};
